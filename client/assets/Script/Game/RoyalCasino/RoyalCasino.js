...
cc.Class({
	...
	onGetSpin: function(){
        cc.RedT.send({g:{royal:{spin:{cuoc: helper.getOnlyNumberInString(this.bet.string), red: this.red, line: this.Line.data}}}});
    },
