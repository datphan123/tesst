	...
	onSelectInput: function(event, select){
		...
		switch(select) {
			case 'right':
				...
				this.inputR1.active=false;
				this.inputLTxt.active=false;
				this.inputL1.active=true;
			break;

			case 'left':
				this.input = this.RedT.board ? this.inputLeft : this.inputLTxt;
				this.inputL1.active=false;
				this.inputRTxt.active=false;
				this.inputR1.active=true;
			break;
		}
	},
