...
var helper    = require('Helper'),
	reel      = require('Caoboi_reel'),
	Line      = require('Caoboi_lines'),
	gameBonus = require('Caoboi_playBonus'),
	notice    = require('Notice'),
	dialog    = require('Caoboi_dialog');
cc.Class({
	...
	onGetSpin: function(){
		cc.RedT.send({g:{caoboi:{spin:{cuoc: helper.getOnlyNumberInString(this.bet.string), line: this.Line.data}}}});
	},
