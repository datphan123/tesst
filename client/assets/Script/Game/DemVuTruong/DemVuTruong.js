...
var helper    = require('Helper'),
	reel      = require('DemVuTruong_reel'),
	Line      = require('DemVuTruong_lines'),
	gameBonus = require('DemVuTruong_playBonus'),
	notice    = require('Notice'),
	dialog    = require('DemVuTruong_dialog');
...
cc.Class({
	...
	onGetSpin: function(){
		cc.RedT.send({g:{royal:{spin:{cuoc: helper.getOnlyNumberInString(this.bet.string), line: this.Line.data}}}});
	},
