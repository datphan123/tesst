...
cc.Class({
	...
	onData: function(data) {
		...
		if (void 0 !== data.DongMauAnhhung){
            this.DongMauAnhhung(data.DongMauAnhhung);
        }
		if (void 0 !== data.mini){
	...
	onGetSpin: function(){
        cc.RedT.send({g:{dm_anhhung:{spin:{cuoc: helper.getOnlyNumberInString(this.bet.string), red: this.red, line: this.Line.data}}}});
    },
