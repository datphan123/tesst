...
var MainGame = cc.Class({
	...
	properties: {
		...
		iconLongLan: cc.Node,
		iconThuyKieu: cc.Node,
		iconMinPoker: 	  cc.Node,
		//iconMinPokerTemp: 	  cc.Node,
		iconMiniCandy: 	  cc.Node,
		//iconMiniCandyTemp: 	  cc.Node,
		iconPubg: 	  cc.Node,
		//iconPubgTemp: 	  cc.Node,
		iconcaothap: 	  cc.Node,
		//iconcaothapTemp: 	  cc.Node,
		iconZeus: cc.Node,
		iconChenthanh: cc.Node,
		iconTamHung: cc.Node,
		iconTaiXiu: cc.Node,
		iconMegaJ: cc.Node,
		redhat: cc.Node,
	...
	onLoad: function () {
		...
		this.iconMNNgu = this.iconMNNgu.getComponent('iconGameHu');
		this.iconKBRed = this.iconKBRed.getComponent('iconGameHu');
		this.iconLongLan = this.iconLongLan.getComponent('iconGameHu');
		this.iconThuyKieu = this.iconThuyKieu.getComponent('iconGameHu');
		...
		this.iconMiniCandy 	   = this.iconMiniCandy.getComponent('iconGameHu');
		//this.iconMiniCandyTemp 	   = this.iconMiniCandyTemp.getComponent('iconGameHu');
		this.iconPubg 	   = this.iconPubg.getComponent('iconGameHu');
		//this.iconPubgTemp 	   = this.iconPubgTemp.getComponent('iconGameHu');
		this.iconcaothap 	   = this.iconcaothap.getComponent('iconGameHu');
		//this.iconcaothapTemp 	   = this.iconcaothapTemp.getComponent('iconGameHu');
		this.iconChenthanh = this.iconChenthanh.getComponent('iconGameHu');
	...
	onGetHu: function () {
		if (void 0 !== cc.RedT.setting.topHu.data) {
			...
			Promise.all(cc.RedT.setting.topHu.data['caothap'].filter(function (temp) {
				...
				.then(result => {
					let h100 = result.filter(function (temp) { return temp.type == 50000 });
					let h1k = result.filter(function (temp) { return temp.type == 100000 });
					let h10k = result.filter(function (temp) { return temp.type == 500000 });

					let r100 = helper.getOnlyNumberInString(this.iconcaothap.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconcaothap.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconcaothap.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconcaothap.hu100, helper.getOnlyNumberInString(this.iconcaothap.hu100.string), h100[0].bet, 4900, true);
						//helper.numberTo(this.iconcaothapTemp.hu100, helper.getOnlyNumberInString(this.iconcaothapTemp.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconcaothap.hu1k, helper.getOnlyNumberInString(this.iconcaothap.hu1k.string), h1k[0].bet, 4900, true);
						//helper.numberTo(this.iconcaothapTemp.hu1k, helper.getOnlyNumberInString(this.iconcaothapTemp.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconcaothap.hu10k, helper.getOnlyNumberInString(this.iconcaothap.hu10k.string), h10k[0].bet, 4900, true);
						//helper.numberTo(this.iconcaothapTemp.hu10k, helper.getOnlyNumberInString(this.iconcaothapTemp.hu10k.string), h10k[0].bet, 4900, true);
					}
				});		
			...
			Promise.all(cc.RedT.setting.topHu.data['arb'].filter(function (temp) {
				...
				.then(result => {
					...
					let r100 = helper.getOnlyNumberInString(this.iconPubg.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconPubg.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconPubg.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconPubg.hu100, helper.getOnlyNumberInString(this.iconPubg.hu100.string), h100[0].bet, 4900, true);
						//helper.numberTo(this.iconPubgTemp.hu100, helper.getOnlyNumberInString(this.iconPubgTemp.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconPubg.hu1k, helper.getOnlyNumberInString(this.iconPubg.hu1k.string), h1k[0].bet, 4900, true);
						//helper.numberTo(this.iconPubgTemp.hu1k, helper.getOnlyNumberInString(this.iconPubgTemp.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconPubg.hu10k, helper.getOnlyNumberInString(this.iconPubg.hu10k.string), h10k[0].bet, 4900, true);
						//helper.numberTo(this.iconPubgTemp.hu10k, helper.getOnlyNumberInString(this.iconPubgTemp.hu10k.string), h10k[0].bet, 4900, true);
					}
				});	
			
				// my_nhan_ngu
			Promise.all(cc.RedT.setting.topHu.data['mn_ngu'].filter(function (temp) {
				return temp.red == true;
			}))
				.then(result => {
					let h100 = result.filter(function (temp) { return temp.type == 100 });
					...
					let r100 = helper.getOnlyNumberInString(this.iconMNNgu.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconMNNgu.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconMNNgu.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconMNNgu.hu100, helper.getOnlyNumberInString(this.iconMNNgu.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconMNNgu.hu1k, helper.getOnlyNumberInString(this.iconMNNgu.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconMNNgu.hu10k, helper.getOnlyNumberInString(this.iconMNNgu.hu10k.string), h10k[0].bet, 4900, true);
					}
				});
			...
			// Kho Báu Red
			Promise.all(cc.RedT.setting.topHu.data['kb_red'].filter(function (temp) {
				return temp.red == true;
			}))
				.then(result => {
					let h100 = result.filter(function (temp) { return temp.type == 100 });
					...
					let r100 = helper.getOnlyNumberInString(this.iconKBRed.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconKBRed.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconKBRed.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconKBRed.hu100, helper.getOnlyNumberInString(this.iconKBRed.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconKBRed.hu1k, helper.getOnlyNumberInString(this.iconKBRed.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconKBRed.hu10k, helper.getOnlyNumberInString(this.iconKBRed.hu10k.string), h10k[0].bet, 4900, true);
					}
				});
			...
			Promise.all(cc.RedT.setting.topHu.data['big_babol'].filter(function (temp) {
				...
				.then(result => {
					...
					let r100 = helper.getOnlyNumberInString(this.iconMiniCandy.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconMiniCandy.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconMiniCandy.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconMiniCandy.hu100, helper.getOnlyNumberInString(this.iconMiniCandy.hu100.string), h100[0].bet, 4900, true);
						//helper.numberTo(this.iconMiniCandyTemp.hu100, helper.getOnlyNumberInString(this.iconMiniCandyTemp.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconMiniCandy.hu1k, helper.getOnlyNumberInString(this.iconMiniCandy.hu1k.string), h1k[0].bet, 4900, true);
						//helper.numberTo(this.iconMiniCandyTemp.hu1k, helper.getOnlyNumberInString(this.iconMiniCandyTemp.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconMiniCandy.hu10k, helper.getOnlyNumberInString(this.iconMiniCandy.hu10k.string), h10k[0].bet, 4900, true);
						//helper.numberTo(this.iconMiniCandyTemp.hu10k, helper.getOnlyNumberInString(this.iconMiniCandyTemp.hu10k.string), h10k[0].bet, 4900, true);
					}
				});	
			...
			//Chens Thanhs
			Promise.all(cc.RedT.setting.topHu.data['chenthanh'].filter(function (temp) {
				return temp.red == true;
			}))
				.then(result => {
					let h100 = result.filter(function (temp) { return temp.type == 100 });
					...
					let r100 = helper.getOnlyNumberInString(this.iconChenthanh.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconChenthanh.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconChenthanh.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconChenthanh.hu100, helper.getOnlyNumberInString(this.iconChenthanh.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconChenthanh.hu1k, helper.getOnlyNumberInString(this.iconChenthanh.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconChenthanh.hu10k, helper.getOnlyNumberInString(this.iconChenthanh.hu10k.string), h10k[0].bet, 4900, true);
					}
				});	
			// Long Lan
			...
			// Thúy Kiều
			Promise.all(cc.RedT.setting.topHu.data['thuy'].filter(function (temp) {
				return temp.red == true;
			}))
				.then(result => {
					let h100 = result.filter(function (temp) { return temp.type == 100 });
					...
					let r100 = helper.getOnlyNumberInString(this.iconThuyKieu.hu100.string);
					let r1k = helper.getOnlyNumberInString(this.iconThuyKieu.hu1k.string);
					let r10k = helper.getOnlyNumberInString(this.iconThuyKieu.hu10k.string);

					if (r100 - h100[0].bet != 0) {
						helper.numberTo(this.iconThuyKieu.hu100, helper.getOnlyNumberInString(this.iconThuyKieu.hu100.string), h100[0].bet, 4900, true);
					}
					if (r1k - h1k[0].bet != 0) {
						helper.numberTo(this.iconThuyKieu.hu1k, helper.getOnlyNumberInString(this.iconThuyKieu.hu1k.string), h1k[0].bet, 4900, true);
					}
					if (r10k - h10k[0].bet != 0) {
						helper.numberTo(this.iconThuyKieu.hu10k, helper.getOnlyNumberInString(this.iconThuyKieu.hu10k.string), h10k[0].bet, 4900, true);
					}
				});	
	...
	actVQMM() {
		...
		actVQMM1() {
            this.panelSupport1.active = !this.panelSupport1.active;
        },
	actSupport() {
            this.panelSupport.active = !this.panelSupport.active;
	...
	fanpage: function () {
		cc.sys.openURL("https://fb.com/bk88otpbot");
	},
	zalo: function () {
		cc.sys.openURL("https://zalo.com/bk88otpbot");
	},
	livechat: function () {
		cc.sys.openURL("https://livechat.com/bk88otpbot");
	},
	ios: function () {
	...
	telegram: function () {
		cc.sys.openURL("https://t.me/bk88otpbot");
	},
