...
cc.Class({
	...
	*/
	...
	showChuyenRed: function () {
		if (cc.RedT.IS_LOGIN) {
			var self = this;
			this.bgShow.active = true;
			if(this.ChuyenRed != null) {
				this.node.active = this.ChuyenRed.node.active = true;
				this.objShow = this.ChuyenRed.node;
				return;
			}
		} else {
			this.showSignIn();
	...
	showPopupSuKien: function (even) {
		//this.bgShow.active = true;
		this.node.active = this.PopupSuKien.active = true;
		this.objShow = this.PopupSuKien;
	},
